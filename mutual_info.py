...
dataset = pd.read_csv('merged_data_drebin.csv') #
...
l=152+1394  #152 is the number of files in malign and 1394 benign(change according to your files)
...
for index, row in dataset.iterrows():
    ...
    c = 152 - a   #change number of files malign     
    d = 1394 - b  #change number of files benign 
